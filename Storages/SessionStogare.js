...
// create new cookie
var name = document.cookie = 'name=Ravi'
console.log("Cookies name is ",name);//name=Ravi

// Create a cookie which will expires in certain date
document.cookie = 'email=ravi@getnada.com;'+new Date(2025,1,1).toUTCString();
var cookies = document.cookie;
console.log("Cookies are ",cookies);
/**
 * Cookies:
 * A cookie is a simple text file that is created when you visit websites on the internet.
 * Websites use cookies to keep track of your activity and your preferences.
 * 1) Capacity to store 4Kb data
 * 2) Accessible from any windows
 * 3) It is manually set
 * 4) Cookies can be stored both in browser and server
 * 5) Cookies can be sent with network call(requests)
 * 6) Cookies are used to remember things on browser for the websites
 * 7) Cookies keeps you logged in
 * 8) First party cookies: Cookies that are created by website you are using
 * 9) Third party cookies: Third party cookies are generated by different websites,most often 
 *    because they are connected to ads on page.
 * 
 * 
 * 
 * 
