...
=> Decorators in TypeScript:
    ->  Decorators are a special kind of declaration in TypeScript that can be attached to 
        classes, methods, properties, or parameters. They provide a way to modify the 
        behavior of the item they are attached to.

    ->  Decorators are essentially functions that can be applied to various class elements 
        to annotate or modify them.

    ->  Decorators in TypeScript enhance or modify class methods, properties, or parameters.
...
/*
=> Decorator Syntax:
    ->  To enable decorators in TypeScript, you need to enable the 'experimentalDecorators' 
    ...
    ->  A decorator is defined as a function, and you can apply it using the @ symbol.
*/
/*
===> Class Decorator:
...
/*
=> Method Decorator:
    ->  A method decorator is applied to a method of a class. It allows you to observe, 
...
// 30
/*
    The Log decorator modifies the add method, logging its arguments before executing the 
    original method.
*/
/*
=> Property Decorator:
    ->  A property decorator is applied to a property in a class, allowing you to observe 
...
/*
==> Parameter Decorator:
    ->  A parameter decorator is applied to the parameters of a class method, allowing you 
        to observe metadata about the parameters.
*/
...
=> Key Takeaways:
    ...
    3)  Useful for cross-cutting concerns like logging, caching, or applying constraints.
*/